...
const DashboardLayout = () => {
  ...
  const navLinks = [
    ...
    { name: "History", path: "/adminDash/history", icon: <RiFileHistoryLine /> },
    { name: "Settings", path: "/adminDash/settings", icon: <FiSettings /> },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-r from-[#e71919] to-[#2e0101] flex justify-center items-center ">
